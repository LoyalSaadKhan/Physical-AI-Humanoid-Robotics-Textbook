...
const config = {
  ...
  organizationName: 'loyalsaadkhan', // Usually your GitHub org/user name.
    ...
    ({
      ...
      navbar: {
        ...
        items: [
          ...
          {
            href: 'https://github.com/loyalsaadkhan',
            label: 'GitHub',
            position: 'right',
          },
          {
  ...
  localeConfigs: {
    ur: {
      ...
      footer: {
        ...
        links: [
          ...
          },
          {
            ...
            items: [
              ...
              {
                label: '(X)Twitter',
                href: 'https://x.com/loyalsaadkhan',
              },
            ],
          },
          {
        ...
        copyright: `Copyright @ ${new Date().getFullYear()} Physical AI & Humanoid Robotics Textbook, Built with ❤️ by Muhammad Saad Khan`,
      },
      prism: {
